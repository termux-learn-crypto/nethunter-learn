...
const toolsData = {
  ...
  'gobuster': {
    ...
    category: 'Web',
    path: '/tool/gobuster',
    desc: 'Directory/file busting tool',
    features: ['Directory enumeration', 'DNS subdomain discovery', 'VHost discovery', 'Multiple wordlist modes'],
    pros: ['Fast', 'HTTPS support', 'Easy to use', 'Active development'],
    cons: ['Limited to web', 'No GUI', 'Needs good wordlist'],
    useCase: 'Jab aapko website ke hidden directories ya subdomains discover karne ho.',
    difficulty: 'Beginner',
  },
  'dirb': {
    name: 'Dirb',
    ...
    features: ['Directory scanning', 'File discovery', 'Recursive scanning', 'Custom extensions'],
    pros: ['Simple', 'Pre-installed on Kali', 'Works well'],
    cons: ['Slower than alternatives', 'No DNS scanning', 'No updates recently'],
    useCase: 'Jab aapko web directories scan karne ho aur Gobuster available nahi hai.',
    difficulty: 'Beginner',
  },
  'nuclei': {
    name: 'Nuclei',
    ...
    features: ['Template-based scanning', 'CVE scanning', 'Multi-protocol', 'Community templates', 'Rate limiting'],
    pros: ['Extremely fast', '4000+ templates', 'Active community', 'Integrations'],
    cons: ['Template quality varies', 'False positives', 'No GUI'],
    useCase: 'Jab aapko automated vulnerability scanning karni ho using community templates.',
    difficulty: 'Intermediate',
  },
  'ffuf': {
    name: 'Ffuf',
    ...
    features: ['Directory fuzzing', 'Parameter fuzzing', 'POST data fuzzing', 'Recursion', 'Filter/match options'],
    pros: ['Fastest web fuzzer', 'Very flexible', 'Great filtering', 'Active development'],
    cons: ['No GUI', 'Requires manual analysis', 'Can be overwhelming'],
    useCase: 'Jab aapko web endpoints fuzz karne ho - directories, parameters, values.',
    difficulty: 'Intermediate',
  },
  'nikto': {
    name: 'Nikto',
    ...
    features: ['Server scanning', 'CGI scanning', 'Fingerprinting', 'Anti-IDS techniques'],
    pros: ['Comprehensive checks', 'Old reliable', 'Detailed output'],
    cons: ['Slow', 'Not updated frequently', 'False positives', 'No longer actively maintained'],
    useCase: 'Jab aapko web server vulnerabilities scan karne ho - outdated versions, dangerous files.',
    difficulty: 'Beginner',
  },
  'john': {
    ...
    category: 'Passwords',
    path: '/tool/john',
    desc: 'Password cracking tool',
    features: ['Hash cracking', 'CPU optimized', 'Incremental mode', 'Wordlist mode', 'External filters'],
    pros: ['Industry standard', 'Highly optimized', 'Many formats', 'Free'],
    cons: ['Slower than Hashcat', 'No GPU by default', 'CLI only'],
    useCase: 'Jab aapke paas limited hardware ho ya CPU-based cracking karni ho.',
    difficulty: 'Intermediate',
  },
  'bettercap': {
    name: 'Bettercap',
    ...
    path: '/tool/bettercap',
    desc: 'Network attack and monitoring framework',
    features: ['MITM attacks', 'ARP spoofing', 'DNS spoofing', 'WiFi deauth', 'HTTP/HTTPS proxy'],
    pros: ['All-in-one', 'Active development', 'Scriptable', 'Modern UI'],
    cons: ['Complex setup', 'Can be unstable', 'Resource heavy'],
    useCase: 'Jab aapko comprehensive network attacks karne ho - MITM, sniffing, phishing.',
    difficulty: 'Advanced',
  },
  'responder': {
    name: 'Responder',
    ...
    features: ['LLMNR poisoning', 'NBT-NS poisoning', 'MDNS poisoning', 'WPAD proxy', 'Authentication capture'],
    pros: ['Very effective on Windows networks', 'Easy to use', 'Great for pentests'],
    cons: ['Limited scope', 'Only Windows', 'Detectable'],
    useCase: 'Jab aap Windows environment mein LLMNR/NBT-NS poisoning karke credentials capture karne ho.',
    difficulty: 'Intermediate',
  },
  'empire': {
    name: 'Empire',
    category: 'Exploitation',
    path: '/tool/empire',
    desc: 'Post-exploitation framework',
    features: ['PowerShell agents', 'Stagers', 'Modules', 'Listener system', 'C2 infrastructure'],
    pros: ['Powerful post-exploitation', 'Active development', 'Great C2', 'Free'],
    cons: ['Complex setup', 'Detected by AV', 'Requires Windows target'],
    useCase: 'Jab aapko Windows post-exploitation karni ho - persistent access, data exfiltration.',
    difficulty: 'Advanced',
  },
}

const comparisonPresets = [
  { label: 'Nmap vs Masscan', tools: ['nmap', 'masscan'], desc: 'Network scanners' },
  { label: 'Wireshark vs Bettercap', tools: ['wireshark', 'bettercap'], desc: 'Network analysis' },
  { label: 'SQLMap vs Burp Suite', tools: ['sqlmap', 'burpsuite'], desc: 'Web testing tools' },
  { label: 'Hydra vs Hashcat', tools: ['hydra', 'hashcat'], desc: 'Password cracking' },
  { label: 'Aircrack vs Wifite', tools: ['aircrack-ng', 'wifite'], desc: 'WiFi hacking' },
  { label: 'Gobuster vs Dirb', tools: ['gobuster', 'dirb'], desc: 'Directory busting' },
  { label: 'Nuclei vs Nikto', tools: ['nuclei', 'nikto'], desc: 'Vuln scanners' },
  { label: 'Ffuf vs Gobuster', tools: ['ffuf', 'gobuster'], desc: 'Content discovery' },
  { label: 'John vs Hashcat', tools: ['john', 'hashcat'], desc: 'Hash cracking' },
  { label: 'Bettercap vs Responder', tools: ['bettercap', 'responder'], desc: 'Network attacks' },
  { label: 'Metasploit vs Empire', tools: ['metasploit', 'empire'], desc: 'Exploitation' },
  { label: 'Nmap vs Wireshark', tools: ['nmap', 'wireshark'], desc: 'Network tools' },
]
